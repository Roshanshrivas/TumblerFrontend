...
const products = [
  ...
  {
    id: 3,
    image: "https://images.unsplash.com/photo-1610824352934-c10d87b700cc?q=80&w=800&auto=format&fit=crop",
        ...
        >
          ...
          >
            {products.map((product) => (
              <div
                key={product.id}
                className="min-w-[260px] sm:min-w-[280px] md:min-w-[300px] lg:min-w-[320px] flex-shrink-0"
              >
