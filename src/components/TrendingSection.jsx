...
const TrendingSection = () => {
  ...
  // Drag scroll handlers (mouse + touch)
  ...
  return (
    <motion.section
      ref={sectionRef}
      className="w-full py-12 md:py-20 bg-gradient-to-b from-blue-50/40 via-white to-white overflow-hidden"
    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Scrollable Products with stagger & drag */}
          <motion.div
            ref={scrollRef}
